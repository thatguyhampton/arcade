...
module TriangleExample {
    ...
    declare var Module: {
        initGL: (width: number, height: number) => number;
        drawTriangle: (x: number, y: number, zoom: number) => void;
    ...
    export class Program implements IPanZoomable {
        ...
        constructor(private canvas: HTMLCanvasElement) {
            ...
            var initialised = Module.initGL(canvas.width, canvas.height);
            if (!initialised) {
        ...
        private render() {
            ...
            Module.drawTriangle(this.translation.originX, this.translation.originY, this.translation.zoom);
